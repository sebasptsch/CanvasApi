...
export class WebhooksSubscriptionsForPlagiarismPlatformService {
   ...
   * @throws ApiError
   */
  public showSingleWebhookSubscription(id: string): CancelablePromise<any> {
   ...
   * @throws ApiError
   */
  public updateWebhookSubscription(id: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "PUT",
      url: "/lti/subscriptions/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public deleteWebhookSubscription(id: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "DELETE",
      url: "/lti/subscriptions/{id}",
      path: {
   ...
   * @throws ApiError
   */
  public createWebhookSubscription(formData: any): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "POST",
      url: "/lti/subscriptions",
      formData: formData,
