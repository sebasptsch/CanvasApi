...
export class FilesService {
     ...
     * @throws ApiError
     */
    public getQuotaInformationCourses(
        courseId: string,
    ): CancelablePromise<any> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public getQuotaInformationGroups(
        groupId: string,
    ): CancelablePromise<any> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public getQuotaInformationUsers(
        userId: string,
    ): CancelablePromise<any> {
        return this.httpRequest.request({
            method: 'GET',
