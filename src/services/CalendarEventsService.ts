...
export class CalendarEventsService {
   ...
   * @throws ApiError
   */
  public reserveTimeSlot(id: string, formData?: any): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "POST",
   ...
   * @throws ApiError
   */
  public createCalendarEvent(formData: any): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "POST",
      url: "/v1/calendar_events",
      formData: formData,
   ...
   * @throws ApiError
   */
  public getCourseTimetable(courseId: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @param includes Array of optional attributes to include. Possible values are "web_conference" and if the calendar_series flag is on, "series_natural_language"
   * @param importantDates Defaults to false
   * If true, only events with important dates set to true will be returned.
   * @param blackoutDate Defaults to false
   * If true, only events with blackout date set to true will be returned.
  ...
  public listCalendarEventsForUser(
    ...
    excludeSubmissionTypes?: Array<string>,
    includes?: Array<string>,
    importantDates?: boolean,
    blackoutDate?: boolean,
  ): CancelablePromise<Array<CalendarEvent>> {
   ...
   * @throws ApiError
   */
  public saveEnabledAccountCalendars(formData?: any): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "POST",
