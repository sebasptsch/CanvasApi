...
export class CoursesService {
   ...
   * @throws ApiError
   */
  public resetCourse(courseId: string): CancelablePromise<Course> {
    return this.httpRequest.request({
      method: "POST",
   ...
   * @throws ApiError
   */
  public removeQuizMigrationAlert(id: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "POST",
   ...
   * @throws ApiError
   */
  public getSingleUser(courseId: string, id: string): CancelablePromise<User> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public getBulkUserProgress(courseId: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public courseActivityStream(courseId: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public courseTodoItems(courseId: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public courseActivityStreamSummary(courseId: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public listStudents(courseId: string): CancelablePromise<Array<User>> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public getCourseSettings(courseId: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public returnTestStudentForCourse(courseId: string): CancelablePromise<User> {
    return this.httpRequest.request({
      method: "GET",
   ...
   * @throws ApiError
   */
  public updateCourse(id: string, formData?: any): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "PUT",
      url: "/v1/courses/{id}",
      path: {
