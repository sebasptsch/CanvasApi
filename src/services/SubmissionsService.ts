...
export class SubmissionsService {
    ...
    public getSingleSubmissionByAnonymousIdSections(
        ...
        assignmentId: string,
        anonymousId: string,
        include?: 'submission_history' | 'submission_comments' | 'rubric_assessment' | 'full_rubric_assessment' | 'visibility' | 'course' | 'user' | 'read_status',
    ): CancelablePromise<any> {
        return this.httpRequest.request({
            method: 'GET',
    ...
    public listGradeableStudents(
        courseId: string,
        assignmentId: string,
    ): CancelablePromise<Array<UserDisplay>> {
        return this.httpRequest.request({
            method: 'GET',
