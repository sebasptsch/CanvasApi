...
export class LoginsService {
   ...
   * @throws ApiError
   */
  public listUserLoginsUsers(userId: string): CancelablePromise<any> {
   ...
   * @throws ApiError
   */
  public deleteUserLogin(userId: string, id: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "DELETE",
   ...
   * @throws ApiError
   */
  public listUserLoginsAccounts(accountId: string): CancelablePromise<any> {
    return this.httpRequest.request({
      method: "GET",
