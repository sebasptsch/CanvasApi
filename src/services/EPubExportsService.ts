...
export class EPubExportsService {
   ...
   * @throws ApiError
   */
  public listCoursesWithTheirLatestEpubExport(): CancelablePromise<
    Array<CourseEpubExport>
  > {
   ...
   * @throws ApiError
   */
  public createEpubExport(courseId: string): CancelablePromise<EpubExport> {
    return this.httpRequest.request({
      method: "POST",
