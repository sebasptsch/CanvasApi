...
export type QuizSettings = {
    ...
    filters?: any;
    /**
     * whether questions should be shown all at once ('none') or one-at-a-time ('all')
     */
    one_at_a_time_type?: string;
    /**
     * whether to allow user to return to previous questions when 'one_at_a_time_type' is set to 'all'
     */
